...
C_SRCS += \
../Core/Src/slave_uart/slave_uart.c 

OBJS += \
./Core/Src/slave_uart/slave_uart.o 

C_DEPS += \
./Core/Src/slave_uart/slave_uart.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/slave_uart/%.o Core/Src/slave_uart/%.su Core/Src/slave_uart/%.cyclo: ../Core/Src/slave_uart/%.c Core/Src/slave_uart/subdir.mk
...
clean: clean-Core-2f-Src-2f-slave_uart

clean-Core-2f-Src-2f-slave_uart:
	-$(RM) ./Core/Src/slave_uart/slave_uart.cyclo ./Core/Src/slave_uart/slave_uart.d ./Core/Src/slave_uart/slave_uart.o ./Core/Src/slave_uart/slave_uart.su

.PHONY: clean-Core-2f-Src-2f-slave_uart
